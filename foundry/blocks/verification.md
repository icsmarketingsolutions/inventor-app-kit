...
- Ejecutá lint, pruebas y build sin warnings.
- Probá en vivo el flujo de usuario afectado y describí exactamente qué observaste.
- Leé la salida completa de cada comando; un exit code aislado no prueba que un servicio arrancó.
